...
const FeedbackCard = ({content, name, title, img, company}) =>  (
    <div className="flex justify-between flex-col
    px-10 py-12 rounded-[20px] max-w-[370px] 
    md:mr-10 sm:mr-5 mr-0 my-5 feedback-card ">

        <img src={company} alt="company_logo"
        className="w-[142px] h-[60px] object-contain rounded-2xl " />
        ...
        <div className="flex flex-row">
            ...
            <div className="flex flex-col ml-4">
                ...
                font-semibbold text-[20px] leading-[32px]
                text-white  ">{name}</h4>
